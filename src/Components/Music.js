...
import ten from "../Images/IMG_7377.JPG";
...
function Music() {
    return (
        <div className="music" id="music">
            ...
            <section><h2>TEN12, An Album By</h2> <span id="simpSpan" style={{fontFamily: "Kristi"}}>simpcxty</span></section>
            <section className="ten12">
                ...
                <section className="tenLinks">
                    ...
                    <a id="apple" href="https://music.apple.com/ng/album/ten12/1591993160" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faApple} size="5x" /></a>                </section>
        </div>
    )
}
