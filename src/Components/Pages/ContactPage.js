...
function Contact() {
    ...
    return (
        <>
            ...
            <main>
            <Grid templateColumns='repeat(2, 1fr)' className="contactGrid" gap={0}>

                <GridItem className="conCard" id='swriter'>SONGWRITER</GridItem>
                <GridItem className="conCard" id='model'>MODEL</GridItem>
                <GridItem className="conCard" id='designer'>DESIGNER</GridItem>
                <GridItem className="conCard" id='visionary'>VISIONARY</GridItem>
